...
import { site, navigation, homepage } from '../src/content/homepage.mjs';
...
export async function build() {
  ...
  const layers = ['tokens','fonts','base','typography','layout','navigation','components','responsive','homepage','motion'];
  ...
  await writeFile(join(root, 'index.html'), renderPage({site,navigation,homepage,stylesheet,script}));
