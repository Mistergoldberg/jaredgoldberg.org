...
<section class="fixture-intro"><div class="layout-shell layout-shell--content text-block"><p class="type-eyebrow">${e(site.identity)}</p><h1 class="site-wordmark" aria-label="${e(site.name)}">${wordmark}</h1><p class="type-meta">${e(site.status)}</p><p>${e(fixture.introduction)}</p></div></section>
